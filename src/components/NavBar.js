...
//             <nav>
//                 <div className='logo'><b>WebTracker</b></div>
...
function NavBar() {
    ...
    return (
        <div>
            <nav>
                <div className='logo'><b>Website Tracker</b></div>
                <label htmlFor='btn' className='fa_icon'>
                    <FaBars/>                
                </label>
                <input type='checkbox' className='checkBox' id='btn' />
                <ul>
                    ...
                    {auth.loggedIn ? (
                        <React.Fragment>
                            <li>
                                <NavLink to='/dashboard' className='hoverLine' style={navLinkStyle} >
                                    Dashboard
                                </NavLink>
                            </li>
                            <li>
                                <label className='show'>Forums +</label>
                                <NavLink to='/forums' className='hoverLine' style={navLinkStyle} >
                                    Forums
                                </NavLink> 
                                <ul>
                                    <li>
                                        <NavLink to='/forum/general' className='hoverLine' style={navLinkStyle} >
                                            General
                                        </NavLink>
                                    </li>
                                    <li>
                                        <NavLink to='/forum/browsing_history' className='hoverLine' style={navLinkStyle} >
                                            Browsing History
                                        </NavLink>
                                    </li>
                                    <li>
                                        <NavLink to='/forum/social_media' className='hoverLine' style={navLinkStyle} >
                                            Social Media
                                        </NavLink>
                                    </li>
                                </ul>
                            ...
                            <li>
                                <NavLink to='/restricted' className='hoverLine' style={navLinkStyle} >
                                    Restricted 
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to='/logout' className='hoverLine' style={navLinkStyle}>
                                    Logout
                                </NavLink>
                            </li>
                        </React.Fragment>
                        ...
                        <React.Fragment>
                            ...
                            <li>
                                <NavLink to='/register' className='hoverLine' style={navLinkStyle}>
                                    Register
                                </NavLink>
                            </li>
                        </React.Fragment>
